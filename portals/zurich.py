"""Zurich adviser portal extraction module."""
...
POLICY_LIST_URL = "https://advisernet.zurich.com.au/policies"
POLICY_ROW_SELECTOR = "table.policy-table tbody tr"
NEXT_PAGE_SELECTOR = "[data-testid='next-page']:not([disabled])"


class ZurichExtractor(BasePortalExtractor):
    async def extract(self, context: BrowserContext) -> list[dict]:
        ...
        log.info("Zurich extraction complete — %d policies", len(policies))
        return policies
