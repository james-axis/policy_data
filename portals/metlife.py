"""MetLife adviser portal extraction module."""
...
POLICY_LIST_URL = "https://adviser.metlife.com.au/policies"
POLICY_ROW_SELECTOR = "#policy-grid tbody tr"
NEXT_PAGE_SELECTOR = "button.next:not(:disabled)"


class MetLifeExtractor(BasePortalExtractor):
    async def extract(self, context: BrowserContext) -> list[dict]:
        ...
        log.info("MetLife extraction complete — %d policies", len(policies))
        return policies
