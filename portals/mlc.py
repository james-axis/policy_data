"""MLC adviser portal extraction module."""
...
POLICY_LIST_URL = "https://adviser.mlc.com.au/insurance/policies"
POLICY_ROW_SELECTOR = "table.policies tbody tr"
NEXT_PAGE_SELECTOR = "a.next-page:not(.disabled)"


class MLCExtractor(BasePortalExtractor):
    async def extract(self, context: BrowserContext) -> list[dict]:
        ...
        log.info("MLC extraction complete — %d policies", len(policies))
        return policies
